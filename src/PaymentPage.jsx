      ...
      <div className="payment-center">
        ...
        <div className="payment-card">
          <form className="payment-form" onSubmit={handleSubmit}>
            ...
            <button type="submit" className="save-btn" disabled={loading} style={{width:'50%', background:'#45ba3fff', color:'#e6e3e3ff', fontWeight:700, fontSize:'1.2rem', borderRadius:'7px', border:'none', padding :'0.9rem 0', marginTop:'0.7rem', marginBottom:'0.2rem', cursor:'pointer'}}>
